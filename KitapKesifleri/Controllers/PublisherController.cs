...
namespace KitapKesifleri.Controllers
{
    public class PublisherController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PublisherName,Adress,Tel")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PublisherName,Adress,Tel")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
